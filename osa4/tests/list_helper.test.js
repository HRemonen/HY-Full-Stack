...
describe('favorite blog', () => {
  ...
  test('multiple blogs should return the most liked one', () => {
    const mostLiked = {
      _id: '5a422b3a1b54a676234d17f9',
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
    ...
    expect(listHelper.favoriteBlog(biggerListOfBlogs)).toEqual(mostLiked)
  })

  test('multiple blogs of same likes should return any of them', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
    ...
    expect(blogs.some(x => x === favorite)).toBe(true)
  })
})

describe('author with most blogs written', () => {
  test('of empty argument is undefined', () => {
  ...
  test('multiple blogs should return the author with most blogs', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
...
describe('author with most liked blogs', () => {
  ...
  test('multiple blogs should return the author with most likes', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
